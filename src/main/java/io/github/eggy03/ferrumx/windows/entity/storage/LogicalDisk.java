 ...
 * LogicalDisk lDisk = LogicalDisk.builder()
 *     .deviceId("C:")
 *     .driveType(3)
 *     .fileSystem("NTFS")
 *     .size(1000204886016L)
 ...
 * LogicalDisk updatedDisk = drive.toBuilder()
 *     .size(2000409772032L)
 *     .fileSystem("ReFS")
 *     .build();
 *
 * }</pre>
 *
 * <p>See {@link DiskDrive} for information about physical disks in the system.</p>
 * <p>See {@link DiskPartition} for information about partitions in a physical disk.</p>
 * @see <a href="https://learn.microsoft.com/en-us/windows/win32/cimwin32prov/win32-logicaldisk">Win32_LogicalDisk</a>
 * @since 2.3.0
 * @author Egg-03
 */
@Value
